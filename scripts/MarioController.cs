...
{
    public class Mario : MonoBehaviour, Character
    {
        ...
        public void HandleSprites()
        {
            switch (powerState)
            {
                case CharacterPowerUpStates.SMALL:
                    ...
                    jumpRange = 0.53f;
                    mario.GetComponent<CapsuleCollider2D>().size = new Vector2(0.33f, .45f);
                ...
                case CharacterPowerUpStates.TALL:
                    ...
                    jumpRange = 1f;
                    mario.GetComponent<CapsuleCollider2D>().size = new Vector2(0.33f, .93f);
